...
public class Server  implements ActionListener {
    ...
    Server() {
        ...
        ImageIcon profileIcon = new ImageIcon(ClassLoader.getSystemResource("icons/1.png")); // Update the path to your profile icon image
...
public void actionPerformed(ActionEvent ae) {
    ...
    rightSide.add(p2, BorderLayout.LINE_END);//end of line se shuru hoga
...
//FORMATTING THE MESSAGE BOX
    public static JPanel formatLabel(String out){
        ...
        output.setBackground(new Color(168,229,193));
